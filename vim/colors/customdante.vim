...
hi Identifier	term=underline ctermfg=darkyellow guifg=darkred
...
" pb30's changes
hi phpStorageClass ctermfg=blue
hi phpComment ctermfg=darkgray
hi phpMethodsVar ctermfg=lightgray
hi phpConditional ctermfg=darkblue
hi phpVarSelector ctermfg=darkyellow
hi javascript ctermfg=lightgray
hi javaScriptBraces ctermfg=darkyellow
hi htmlTag ctermfg=darkblue
